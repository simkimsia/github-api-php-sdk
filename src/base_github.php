...
/**
 * Provides access to the GitHub API.  This class provides
...
/**
 * Maps aliases to GitHub domains.
 */
...
/**
   ...
   * if the GitHub user is not connected.
   *
...
/**
   ...
   *
   * @return integer The id of the connected GitHub user,
...
/**
   * Get a login status URL to fetch the status from GitHub.
   *
   * @param array $params Provide custom parameters
   * @return string The URL for the logout flow
   */
...
/**
   ...
   * The cookie is not set by the BaseGitHub class, but
...
/**
   ...
   * metadata. The cookie is not set by the BaseGitHub class, but it may be
...
/**
   ...
   * seemingly legitimate.  It relies on GitHub's Graph API
   * to retrieve user information and then extract
   * the user ID.
   *
   * @return integer Returns the UID of the GitHub user, or 0
   *                 if the GitHub user could not be determined.
   */
...
/**
  ...
  protected function makeRequest($url, $params, $ch=null) {
    ...
    if ($result === false) {
      $e = new GitHubApiException(array(
...
/**
   ...
   * a brute-force search of the very small list of GitHub-specific
...
/**
  ...
  protected function throwAPIException($result) {
    $e = new GitHubApiException($result);
    switch ($e->getType()) {
      // OAuth 2.0 Draft 00 style
      case 'OAuthException':
        // OAuth 2.0 Draft 10 style
...
/**
   ...
   * a concrete subclass, as they are in the provided GitHub class.
   * The GitHub class uses PHP sessions to provide a primitive
...
/**
   * Get the data for $key, persisted by BaseGitHub::setPersistentData()
   *
